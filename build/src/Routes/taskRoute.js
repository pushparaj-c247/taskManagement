...
router.put("/updateTask", passport_1.default.authenticate("jwt", { session: false }), (0, authorization_1.default)("admin"), taskController_1.updateTaskController);
router.delete("/deleteTask", passport_1.default.authenticate("jwt", { session: false }), (0, authorization_1.default)("admin"), taskController_1.deleteTaskcontroller);
