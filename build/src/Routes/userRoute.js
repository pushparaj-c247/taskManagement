...
routers.post("/createUser", passport_1.default.authenticate('jwt', { session: false }), (0, authorization_1.default)("user"), userController_1.createUserController);
routers.put("/updateUser/:id", passport_1.default.authenticate('jwt', { session: false }), (0, authorization_1.default)("user"), userController_1.updateUserController);
routers.delete("/deleteUser/:id", passport_1.default.authenticate('jwt', { session: false }), (0, authorization_1.default)("user"), userController_1.deleteUsercontroller);
