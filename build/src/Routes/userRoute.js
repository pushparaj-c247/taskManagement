...
router.put("/updateUser/:id", passport_1.default.authenticate('jwt', { session: false }), (0, authorization_1.default)("user"), userController_1.updateUserController);
router.delete("/deleteUser/:id", passport_1.default.authenticate('jwt', { session: false }), (0, authorization_1.default)("user"), userController_1.deleteUsercontroller);
...
router.post("/login", [expressValidator.passwordValidation, expressValidator.emailValidation], userController_1.loginController);
